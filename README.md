...
- [@vitejs/plugin-react](https://github.com/vitejs/vite-plugin-react/blob/main/packages/plugin-react) uses[Bael](https://babeljs.io/) (r[oc(hp://xc.rs) wn [rldow-e]http://e) 
